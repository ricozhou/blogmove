...
public class Blogmove {
	 ...
	 * @param moveUserId
	 * @param moveNum
	 * @param moveArticleEditor
	 * @param moveColumn
	 * @param moveBlogStatus
	 * @param moveUseOriginalTime
	 * @param moveSaveImg
	 * @param moveRemoveRepeat
	 * @param moveWebsiteUrl
	 * @param moveAddWaterMark
	 * @param blogAuthor
	 */
	public Blogmove(String moveWebsiteId, String moveUserId, Integer moveNum, Integer moveArticleEditor,
			String moveColumn, Integer moveBlogStatus, Integer moveUseOriginalTime, Integer moveSaveImg,
			Integer moveRemoveRepeat, String moveWebsiteUrl, Integer moveAddWaterMark, String blogAuthor,Integer moveMode) {
		super();
	...
	public String toString() {
		return "Blogmove [blogMoveId=" + blogMoveId + ", moveWebsiteId=" + moveWebsiteId + ", moveUserId=" + moveUserId
				+ ", moveNum=" + moveNum + ", moveArticleEditor=" + moveArticleEditor + ", moveColumn=" + moveColumn
				+ ", moveBlogStatus=" + moveBlogStatus + ", moveUseOriginalTime=" + moveUseOriginalTime
				+ ", moveSaveImg=" + moveSaveImg + ", moveRemoveRepeat=" + moveRemoveRepeat + ", flag=" + flag
				+ ", moveStopMode=" + moveStopMode + ", moveSuccess=" + moveSuccess + ", moveSuccessNum="
				+ moveSuccessNum + ", moveMessage=" + moveMessage + ", moveMode=" + moveMode + ", moveWebsiteUrl="
				+ moveWebsiteUrl + ", moveFileNames=" + moveFileNames + ", moveFileONames=" + moveFileONames
				+ ", moveAddWaterMark=" + moveAddWaterMark + ", createBy=" + createBy + ", createTime=" + createTime
				+ ", finishTime=" + finishTime + ", takeTime=" + takeTime + ", remark=" + remark + ", blogAuthor="
				+ blogAuthor + "]";
	}
