...
import blogmove.utils.BlogMoveCSDNUtils;
import blogmove.utils.BlogMoveCnBlogUtils;
import blogmove.utils.BlogMoveCommonUtils;
import blogmove.utils.BlogMoveJianShuUtils;
import blogmove.utils.BlogMoveOsChinaUtils;
	...
	public String getTouTiaoArticleUrlList(Blogmove blogMove, String oneUrl, List<String> urlList)
		...
		for (Object obj : jsonarray) {
			...
			if (url != null) {
				...
				if (urlList.size() < blogMove.getMoveNum()) {
					System.out.println("https://www.toutiao.com/i" + url);
